  ...
  plugin.info = {
    ...
    parameters: {
      ...
      preamble: {
        ...
        default: "Please transcribe (copy) the text in the image below into the input field, but only transcribe the <strong>second and fourth sentences</strong>.<br>Add an exclamation point at the end of the <strong>second sentence you have typed out</strong> instead of the question mark. </br>Be exact and make sure to get all characters correct. We just need to make sure you're paying attention and speak English.",
