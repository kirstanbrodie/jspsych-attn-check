...
|compare_to|string|If left blank, will compare to the corresponding text for the default image that is randomly assigned based on the default instructions (fourth sentence, changed punctuation).|The text string that the participant response is compared to.|
